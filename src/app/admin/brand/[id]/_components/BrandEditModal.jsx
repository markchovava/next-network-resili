...
import { _brandUpdateAction } from '@/actions/BrandActions';
...
export default function BrandEditModal({id, domData, getData, isModal, setIsModal}) {
    ...
    async function postData() {
        ...
        try{
            const res = await _brandUpdateAction(formData, id)
            console.log('res', res)
            if(res?.status == 1) {
                await getData();
